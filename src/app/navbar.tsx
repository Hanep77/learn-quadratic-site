...
export default function Navbar() {
  ...
  return (
    <header className={`px-4 lg:px-0 fixed top-0 left-0 right-0 h-16 bg-[rgba(28,3,50,.2)] ${sidebar && 'bg-[rgba(28,3,50,1)] border-none'} backdrop-blur border-b border-violet-500 z-30`}>
