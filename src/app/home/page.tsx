  ...
  return (
    <>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center">
        <h2 className="text-2xl font-semibold mb-16">Sekilas tentang website ini</h2>
      ...
      <section className="min-h-screen px-4 lg:px-0 flex flex-col justify-center items-center" id="more" style={{ background: "linear-gradient(rgba(28,3,50,1), rgba(28,3,50,.7)), url(graph-paper.svg)" }}>
