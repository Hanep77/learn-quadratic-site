  ...
  return (
    <>
      <section className="min-h-screen">
        ...
        <div className="absolute min-h-screen px-4 lg:px-0 w-full bg-gradient-to-b from-[rgba(128,21,174,0.8)] to-[rgba(28,3,50,1)]">
          <div className="min-h-screen flex justify-center items-center">
            <div className="text-center max-w-screen-md">
              ...
              <div className="max-w-[570px] m-auto">
                <p className="text-lg md:text-xl text-violet-400 font-light">Gabung Sekarang dan Rasakan Serunya Belajar Kalkulus
      ...
      <section className="min-h-screen bg-[rgba(28,3,50,1)] px-4 lg:px-0 flex flex-col justify-center items-center" id="more">
        <div className="text-justify max-w-screen-md">
          <h1 className="text-3xl md:text-5xl font-bold mb-8 text-center">Apa itu fungsi kuadrat?</h1>
          <div className="text-lg text-violet-300 font-light flex flex-col md:flex-row gap-5">
            <div>
              <p>
